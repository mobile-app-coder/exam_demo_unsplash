...
class CollectionModel {
  ...
  factory CollectionModel.fromMap(Map<String, dynamic> json) => CollectionModel(
    ...
    previewPhotos: List<PreviewPhoto>.from(json["preview_photos"].map((x) => PreviewPhoto.fromMap(x))),
  );
  ...
  Map<String, dynamic> toMap() => {
    ...
    "preview_photos": List<dynamic>.from(previewPhotos.map((x) => x.toMap())),
  };
}
...
class CollectionModelCoverPhoto {
  ...
  factory CollectionModelCoverPhoto.fromMap(Map<String, dynamic> json) => CollectionModelCoverPhoto(
    id: json["id"],
    slug: json["slug"],
    ...
    topicSubmissions: PurpleTopicSubmissions.fromMap(json["topic_submissions"]),
...
class AlternativeSlugs {
  ...
  factory AlternativeSlugs.fromMap(Map<String, dynamic> json) => AlternativeSlugs(
    en: json["en"],
    es: json["es"],
    ja: json["ja"],
    fr: json["fr"],
...
class PurpleTopicSubmissions {
  ...
  factory PurpleTopicSubmissions.fromMap(Map<String, dynamic> json) => PurpleTopicSubmissions(
    experimental: json["experimental"] == null ? null : The3DRenders.fromMap(json["experimental"]),
    ...
    wallpapers: json["wallpapers"] == null ? null : CoolTones.fromMap(json["wallpapers"]),
    texturesPatterns: json["textures-patterns"] == null ? null : CoolTones.fromMap(json["textures-patterns"]),
    coolTones: json["cool-tones"] == null ? null : CoolTones.fromMap(json["cool-tones"]),
...
class CollectionModelLinks {
  ...
  factory CollectionModelLinks.fromMap(Map<String, dynamic> json) => CollectionModelLinks(
    self: json["self"],
    html: json["html"],
    photos: json["photos"],
...
class Ancestry {
  ...
  factory Ancestry.fromMap(Map<String, dynamic> json) => Ancestry(
    ...
    category: json["category"] == null ? null : TypeClass.fromMap(json["category"]),
    subcategory: json["subcategory"] == null ? null : TypeClass.fromMap(json["subcategory"]),
  );
...
class SourceCoverPhoto {
  ...
  factory SourceCoverPhoto.fromMap(Map<String, dynamic> json) => SourceCoverPhoto(
    ...
    description: json["description"],
    altDescription: json["alt_description"],
    breadcrumbs: List<Breadcrumb>.from(json["breadcrumbs"].map((x) => Breadcrumb.fromMap(x))),
    urls: Urls.fromMap(json["urls"]),
    links: CoverPhotoLinks.fromMap(json["links"]),
    likes: json["likes"],
    likedByUser: json["liked_by_user"],
    currentUserCollections: List<dynamic>.from(json["current_user_collections"].map((x) => x)),
    sponsorship: json["sponsorship"],
    topicSubmissions: FluffyTopicSubmissions.fromMap(json["topic_submissions"]),
    assetType: assetTypeValues.map[json["asset_type"]],
...
class FluffyTopicSubmissions {
  ...
  factory FluffyTopicSubmissions.fromMap(Map<String, dynamic> json) => FluffyTopicSubmissions(
    animals: json["animals"] == null ? null : The3DRenders.fromMap(json["animals"]),
    health: json["health"] == null ? null : The3DRenders.fromMap(json["health"]),
    nature: json["nature"] == null ? null : The3DRenders.fromMap(json["nature"]),
    wallpapers: json["wallpapers"] == null ? null : The3DRenders.fromMap(json["wallpapers"]),
    architectureInterior: json["architecture-interior"] == null ? null : The3DRenders.fromMap(json["architecture-interior"]),
    colorOfWater: json["color-of-water"] == null ? null : The3DRenders.fromMap(json["color-of-water"]),
    currentEvents: json["current-events"] == null ? null : The3DRenders.fromMap(json["current-events"]),
    spirituality: json["spirituality"] == null ? null : The3DRenders.fromMap(json["spirituality"]),
    sports: json["sports"] == null ? null : The3DRenders.fromMap(json["sports"]),
    people: json["people"] == null ? null : The3DRenders.fromMap(json["people"]),
  );
